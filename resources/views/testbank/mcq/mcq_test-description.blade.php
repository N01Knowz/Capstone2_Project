...
<div class="add-item-container" id="add_item_container">
    <div class="add-item-sub-container" id="add_item_sub_container">
        <div class="add-item-modal-header">
            <p class="add-item-enter-answer">Download template <span><a href="{{ route('mcq-excel') }}" class="btn btn-primary">here</a></span></p>
        ...
        <div class="add-item-modal-body">
            <div class="add-item-modal-body-content">
                ...
                <ul>
                    ...
                    <li><strong>Answer Number:</strong> Number representing the correct answer choice <strong>(Required)</strong></li>
                    <li><strong>Options:</strong> List of individual options <strong>(Option 1 is Required)</strong></li>
                    <li><strong>If there are questions that fails to follow the template. It will be skipped and not be uploaded</strong></li>
                </ul>
                <form action="/mcq/{{$test->qzID}}/create_multiple_questions" method="POST" id="add_item_form" class="upload-form" enctype="multipart/form-data">
                    @csrf
                    <strong>Upload items here.</strong>
                    <input type="file" name="mcq_items" accept=".xlsx, .xls">
                </form>
            </div>
        </div>
