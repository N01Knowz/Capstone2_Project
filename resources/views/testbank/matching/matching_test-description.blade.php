            ...
            <div class="test-body-content">
                ...
                <div class="test-questions-container">
                    <div class="test-questions-table-container">
                        ...
                        <table class="questions-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <p>There are 207 bones in the human body.</p>
                                    </td>
                                    <td>
                                        <p>1.00</p>
                                    </td>
                                    <td>
                                        <div class="questions-table-buttons-column-div">
                                            <button class="questions-table-buttons buttons-deactivate-button"><img src="/images/unlock-icon.png">
                                                <p>Deactivate</p>
                                            </button>
                        ...
                        <button class="add-test-question-button"><img src="/images/add-test-icon.png">
                            <p>Add Test Item</p>
                        </button>
                    </div>
                </div>
