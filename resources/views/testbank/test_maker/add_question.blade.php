    ...
    <form method="get" id="filter_form">
        ...
        <div style="position: relative; width: 100%;">
            ...
            <select name="subject" class="textinput-base textarea-title text-input-background">
                ...
                <option value="{{$subject->subjectName}}" @if($subjectSelected == $subject->subjectName) selected @endif>{{$subject->subjectName}}</option>
                @endforeach
            </select>
        </div>
    ...
    <form method="POST" id="save_form">
        ...
        <div class="dropdown-container">
            <div class="dropdown-header">
                <button class="dropdown-title" type="button" onclick="showDropdown()" @if ($testType=='Essay' ) data-dropdown-icon="{{ 'dropdown-icon-' . $testQuery->essID }}" data-dropdown-id="{{ 'dropdown-content-' . $testQuery->essID }}"> @endif
                ...
                <input type="checkbox" @if ($testType=='Essay' ) value="{{ $testQuery->essID }}" id="parent-checkbox-{{ $testQuery->essID }}" class="dropdown-checkbox" data-dropdown-checkboxes="dropdown-questions-checkbox-{{ $testQuery->essID }}" @endif @if ($testType=='Matching' ) value="{{ $testQuery->mtID }}" id="parent-checkbox-{{ $testQuery->mtID }}" class="dropdown-checkbox" data-dropdown-checkboxes="dropdown-questions-checkbox-{{ $testQuery->mtID }}" @endif @if ($testType=='Enumeration' ) value="{{ $testQuery->etID }}" id="parent-checkbox-{{ $testQuery->etID }}" class="dropdown-checkbox" data-dropdown-checkboxes="dropdown-questions-checkbox-{{ $testQuery->etID }}" @endif @if ($testType=='Mcq' ) value="{{ $testQuery->qzID }}" id="parent-checkbox-{{ $testQuery->qzID }}" class="dropdown-checkbox" data-dropdown-checkboxes="dropdown-questions-checkbox-{{ $testQuery->qzID }}" @endif @if ($testType=='Tf' ) value="{{ $testQuery->tftests }}" id="parent-checkbox-{{ $testQuery->tfID }}" class="dropdown-checkbox" data-dropdown-checkboxes="dropdown-questions-checkbox-{{ $testQuery->tfID }}" @endif @if ($testType=='Mtf' ) value="{{ $testQuery->mtfID }}" id="parent-checkbox-{{ $testQuery->mtfID }}" class="dropdown-checkbox" data-dropdown-checkboxes="dropdown-questions-checkbox-{{ $testQuery->mtfID }}" @endif @if (!$testQuery->in_test_makers) name="test_checkbox_add[]" @endif
                @if ($testQuery->in_test_makers) checked disabled @endif
                @if (in_array($testType, ['Mcq', 'Tf', 'Mtf'])) onclick="toggleCheckboxes(this)" @endif>
            </div>
            <div class="dropdown-content" style="background-color: white;" @if ($testType=='Essay' ) id="{{ 'dropdown-content-' . $testQuery->essID }}"> @endif
                ...
                <div class="dropdown-question-header">
                    ...
                    <input type="checkbox" class="dropdown-checkbox @if (!$questionQuery->in_test_makers) dropdown-questions-checkbox-{{ $testQuery->qzID }} @endif" data-parent-checkbox="parent-checkbox-{{ $testQuery->qzID }}" onclick="updateSelectAllState(this)" @if ($questionQuery->in_test_makers) checked disabled @endif
                ...
                <div class="dropdown-question-header">
                    ...
                    <input type="checkbox" class="dropdown-checkbox @if (!$questionQuery->in_test_makers) dropdown-questions-checkbox-{{ $testQuery->tfID }} @endif" data-parent-checkbox="parent-checkbox-{{ $testQuery->tfID }}" onclick="updateSelectAllState(this)" @if ($questionQuery->in_test_makers) checked disabled @endif
                    @if (!$questionQuery->in_test_makers) name="question_checkbox_add[]" @endif
                    value="{{ $questionQuery->itmID }}">
                </div>
                @endif
                ...
                <div class="dropdown-question-header">
                    ...
                    <input type="checkbox" class="dropdown-checkbox @if (!$questionQuery->in_test_makers) dropdown-questions-checkbox-{{ $testQuery->mtfID }} @endif" data-parent-checkbox="parent-checkbox-{{ $testQuery->mtfID }}" onclick="updateSelectAllState(this)" @if ($questionQuery->in_test_makers) checked disabled @endif
                    @if (!$questionQuery->in_test_makers) name="question_checkbox_add[]" @endif
                    value="{{ $questionQuery->itmID }}">
                </div>
                @endif
