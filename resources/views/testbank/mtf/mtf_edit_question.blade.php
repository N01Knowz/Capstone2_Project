...
<div class="test-body-content">
    ...
    <form method="POST" action="/mtf/{{$test->mtfID}}/{{$question->itmID}}/edit" class="test-add-question-container" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="item-answer-points-container">
            ...
            <div class="item-point-container">
                ...
                <input type="text" class="point-input" id="point-input" value="{{$question->itmPoints1}}" name="question_point">
            </div>
        </div>
        ...
        <div class="item-answer-points-container">
            <div class="correct-answer-container">
                ...
                <input type="text" class="select-option" value="{{$question->itmPoints2}}" id="explanation-points" name="explanation_point">
            </div>
            <div class="item-point-container">
                <p class="text-input-label">Total Point(s) <span class="red-asterisk">*</span></p>
                <input type="text" class="point-input" value="{{$question->itmPointsTotal}}" readonly id="total-points">
            </div>
        </div>
