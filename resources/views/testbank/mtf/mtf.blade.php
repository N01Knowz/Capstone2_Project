...
<body>
                    ...
                    <tbody>
                        ...
                        <tr id="test-question-description">
                            ...
                            <td class="test-body-column test-body-status" data-id="{{$test->mtfID}}">
                                <div>
                                    <p class="test-status-word">@if($test->mtfIsPublic == 0) Private @else Public @endif</p><img src="/images/eye-icon-light.png" class="test-status-icon">
                                </div>
                            </td>
                            ...
                            <td class="test-body-buttons-column" id="test-bb">
                                <div class="test-body-buttons-column-div">
                                    <button class="test-body-buttons buttons-add-question-button" id="test-add-question" data-id="{{$test->mtfID}}"><img src="/images/add-test-icon.png" class="test-body-buttons-icons">
                                        <p>Add Question</p>
                                    </button>
                                    ...
                                    <form method="GET" action="/print/{{$test->mtfID}}" class="button-delete-form" target="_blank">
    ...
    <script>
        ...
        document.getElementById("test-add-question").onclick = function() {
            ...
            window.location.href = "/mtf/" + dataID + "/create_question";
        }
